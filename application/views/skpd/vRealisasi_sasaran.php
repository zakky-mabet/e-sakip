					...
					<table class="table table-bordered bg-white">
						<thead class="bg-blue">
							<tr>
								...
								<td  colspan="2" class="bg-silver text-right">
									...
									<button type="button" class="btn btn-sm btn-success"><i class="fa fa-navicon"></i> Kegiatan</button>
								</td>
							</tr>
							<tr>
			            ...
			            foreach ($this->mrealisasi_sasaran->getIndikatorSasarantoTarget($sasaran->id_sasaran, $tahun ) as $key => $indikator) : 
							...
							<tr>
								...
								<input type="text" name="update[keterangan][<?php echo $indikator->id_realisasi_indikator_sasaran ?>]" value="<?php echo $indikator->keterangan  ?>" class="form-control"></td>
							</tr>
						<?php endforeach ?>
