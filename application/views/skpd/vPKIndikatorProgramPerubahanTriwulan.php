					...
					<table class="table table-bordered">
						<thead class="bg-blue">
							...
							<tr>
								...
								<th class="text-center" width="80">Target PK</th>
						...
						?>
							...
							$PKPerubahan = $this->mprogram->getPKPerubahanIndikatorProgram($indikator->id_indikator_kinerja_program, $tahun, "T".$triwulan);
							?>
							<tr>
								<td class="text-center">
									<small><?php echo @$PKtahun->nilai_target ?></small>
								</td>
								<td>
								...
								<td class="text-center">
									<textarea name="sebab[<?php echo @$PKPerubahan->id_pk_program_perubahan ?>]" rows="2" class="form-control"><?php echo @$PKtahun->sebab ?></textarea>
								</td>
							</tr>
							<?php endfor; ?>
						<?php  
