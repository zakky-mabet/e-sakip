<div class="row">
	...
	<?php echo form_open(base_url("skpd/pkperubahankegiatan/saveoutputkegiatan")); ?>
	<div class="col-md-10">
		<div class="nav-tabs-custom">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
	                  <li class="<?php echo active_link_method('index','program'); ?>">
	                    <a href="<?php echo base_url("skpd/pkperubahankegiatan/") ?>"> Tahunan</a>
	                  </li>
	                  <li class="<?php echo active_link_method('anggaran','program'); ?>">
	                    <a href="<?php echo base_url("skpd/pkperubahankegiatan/triwulan") ?>">Triwulan</a>
	                  </li>
					</ul>
              	</li>
            </ul>
            <div class="tab-content">
				...
				{
					$this->load->view('skpd/vPKPerubahanOuputKegiatanTahun', $this->data);
				} else {
					$this->load->view('skpd/vPKPerubahanOuputKegiatanTriwulan', $this->data);
				}
				?>
