...
<style>div.mail-footer > table {  margin-top: 100px; }</style>
    <div class="content">
        <div class="mail-heading">
            <h5 class="mail-name upper">PERNYATAAN PERJANJIAN KINERJA PERUBAHAN</h5><br>
            <h5 class="mail-name upper"><?php echo strtoupper($this->session->userdata('SKPD')->nama) ?></h5> <br>
            <h5 class="main-name upper">PERJANJIAN KINERJA PERUBAHAN TAHUN <?php echo $this->tahun ?></h5>
        </div>
