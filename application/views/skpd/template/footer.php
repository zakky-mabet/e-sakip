...
?>
   ...
   <div class="container text-center">
      <small>Hak Cipta &copy; 2017 <?php if(date('Y')!=2017) echo "- ".date('Y'); ?> Seketariat Bangka Tengah All rights reserved. Develop By <a href="http://teitramega.co.id" target="_blank">Teitra Mega</a>
        .<small>
   </div>
</footer>
