					...
					<table class="table table-bordered bg-white">
						...
						?>
							<tr>
								...
								<td>
									<input type="text" name="anggaran[<?php echo @$PK->id_pk_anggaran_kegiatan ?>]" class="form-control inputmask" value="<?php echo @$PK->nilai_anggaran ?>">
								</td>
								<td>
									<textarea name="sebab[<?php echo @$PK->id_pk_anggaran_kegiatan ?>]" rows="2" class="form-control"><?php echo @$PK->sebab ?></textarea>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
