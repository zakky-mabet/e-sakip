<div class="row">
	<?php echo form_open(base_url("skpd/kegiatan/savepenanggungjawab")); ?>
	<div class="col-md-10">
					...
					<table class="table table-bordered bg-white">
						<thead class="bg-blue">
							...
							<tr>
								...
								<th class="text-center" width="200">Penaggung Jawab</th>
							</tr>
						</thead>
						<tbody>
						<?php  
						...
						foreach($this->kgiatan->getKegiatanProgramByProgram( $program->id_program ) as $keyKegiatan => $kegiatan) :
							$pjk = $this->kgiatan->getPenanggungJawabKegiatanByKegiatanTahun($kegiatan->id_kegiatan, $tahun);
						?>
							<tr>
								<td><?php echo ++$keyKegiatan ?>.</td>
								<td><?php echo $kegiatan->deskripsi; ?></td>
								<td><input type="text" name="penanggung[<?php echo @$pjk->id_penangung_jawab_kegiatan ?>]" value="<?php echo @$pjk->penanggung_jawab ?>" class="form-control"></td>
							</tr>
						<?php endforeach; ?>
						</tbody>
					</table>
